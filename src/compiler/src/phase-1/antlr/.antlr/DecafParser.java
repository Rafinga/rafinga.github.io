// Generated from /Users/sabrinado/sp25-team1-waffle/src/phase-1/antlr/DecafParser.g4 by ANTLR 4.13.1
...
public class DecafParser extends Parser {
	...
	public static final int
		...
		DIVIDE=18, MODULO=19, INCREMENT=20, EQUAL=21, NOT_EQUAL=22, LESS_THAN=23, 
		GREATER_THAN=24, LESS_EQUAL=25, GREATER_EQUAL=26, AND=27, OR=28, NOT=29, 
		LEFT_PAREN=30, RIGHT_PAREN=31, LEFT_BRACE=32, RIGHT_BRACE=33, LEFT_BRACKET=34, 
		RIGHT_BRACKET=35, SEMI=36, COMMA=37, LONGHEXLITERAL=38, LONGDECLITERAL=39, 
		DECIMALLITERAL=40, HEXLITERAL=41, CHARLITERAL=42, STRINGLITERAL=43, BOOLLITERAL=44, 
		ID=45, WS=46, LINE_COMMENT=47, BLOCK_COMMENT=48;
	public static final int
		...
		RULE_decrement = 16, RULE_method_call = 17, RULE_method_name = 18, RULE_location = 19, 
		RULE_expr = 20, RULE_extern_arg = 21, RULE_bin_op = 22, RULE_arith_op = 23, 
		RULE_rel_op = 24, RULE_eq_op = 25, RULE_cond_op = 26, RULE_literal = 27, 
		RULE_int_literal = 28, RULE_long_literal = 29;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MULTIPLY", "DIVIDE", "MODULO", "INCREMENT", "EQUAL", "NOT_EQUAL", "LESS_THAN", 
			"GREATER_THAN", "LESS_EQUAL", "GREATER_EQUAL", "AND", "OR", "NOT", "LEFT_PAREN", 
			"RIGHT_PAREN", "LEFT_BRACE", "RIGHT_BRACE", "LEFT_BRACKET", "RIGHT_BRACKET", 
			"SEMI", "COMMA", "LONGHEXLITERAL", "LONGDECLITERAL", "DECIMALLITERAL", 
			"HEXLITERAL", "CHARLITERAL", "STRINGLITERAL", "BOOLLITERAL", "ID", "WS", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 35184372089816L) != 0)) {
				{
				{
				setState(135);
				statement();
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 61299383933952L) != 0)) {
				{
				setState(190);
				expr(0);
				}
	...
	public static class DecrementContext extends ParserRuleContext {
		public List<TerminalNode> MINUS() { return getTokens(DecafParser.MINUS); }
		public TerminalNode MINUS(int i) {
			return getToken(DecafParser.MINUS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DecafParserListener ) ((DecafParserListener)listener).enterDecrement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DecafParserListener ) ((DecafParserListener)listener).exitDecrement(this);
		}
	}
	...
	public final Method_callContext method_call() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 70095476956160L) != 0)) {
					{
					setState(240);
					extern_arg();
					setState(245);
	...
	public final Extern_argContext extern_arg() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_extern_arg);
		try {
			setState(312);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Long_literalContext long_literal() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_long_literal);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
