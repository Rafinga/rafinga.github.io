...
public interface DecafParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecafParser#decrement}.
	 * @param ctx the parse tree
	 */
	void enterDecrement(DecafParser.DecrementContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecafParser#decrement}.
	 * @param ctx the parse tree
	 */
	void exitDecrement(DecafParser.DecrementContext ctx);
	/**
